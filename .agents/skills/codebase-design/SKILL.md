...
- **Exploring alternative interfaces**, see [DESIGN-IT-TWICE.md](DESIGN-IT-TWICE.md): compare materially different designs, using parallel sub-agents only when the alternatives are independent and the extra context is justified.

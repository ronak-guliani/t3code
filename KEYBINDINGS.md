...
- `preview.toggle`: open or close the in-app browser preview panel
- `preview.refresh`: reload the active preview tab (in focused preview context by default)
- `preview.focusUrl`: focus the preview URL input (in focused preview context by default)
- `preview.zoomIn`: zoom the active preview in (in focused preview context by default)
- `preview.zoomOut`: zoom the active preview out (in focused preview context by default)
- `preview.resetZoom`: reset the active preview zoom (in focused preview context by default)

...
import { mobileConnectionDiagnosticsLayer, mobileConnectionPolicyLayer } from "./diagnostics";
...
type ConnectionLayerSource =
  ...
  | typeof mobileConnectionPolicyLayer
  | typeof mobileConnectionDiagnosticsLayer
...
const connectionLayer = Layer.merge(
  mobileBackgroundActivityReporterLayer,
  mobileConnectionDiagnosticsLayer,

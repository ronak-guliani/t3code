...
import Migration0027 from "./Migrations/026_ProjectionThreadSessionResumeCursor.ts";
import Migration0028 from "./Migrations/027_ProjectionThreadsPendingRuntimeMode.ts";
...
export const migrationEntries = [
  ...
  [27, "ProjectionThreadSessionResumeCursor", Migration0027],
  [28, "ProjectionThreadsPendingRuntimeMode", Migration0028],
] as const;

...
import Migration0037 from "./Migrations/037_ProjectionTurnSpeculativePatch.ts";
import Migration0038 from "./Migrations/038_ProjectionThreadSessionStartCheckpoint.ts";
...
export const migrationEntries = [
  ...
  [37, "ProjectionTurnSpeculativePatch", Migration0037],
  [38, "ProjectionThreadSessionStartCheckpoint", Migration0038],
] as const;

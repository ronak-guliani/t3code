...
import Migration0104 from "./Migrations/104_ProjectionThreadPendingPullRequestAssociation.ts";
...
export const migrationEntries = [
  ...
  [104, "ProjectionThreadPendingPullRequestAssociation", Migration0104],
] as const;

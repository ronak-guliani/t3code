...
import Migration0026 from "./Migrations/026_ProjectionThreadSessionResumeCursor.ts";
import Migration0027 from "./Migrations/027_ProjectionThreadsPendingRuntimeMode.ts";
...
export const migrationEntries = [
  ...
  [26, "ProjectionThreadSessionResumeCursor", Migration0026],
  [27, "ProjectionThreadsPendingRuntimeMode", Migration0027],
] as const;

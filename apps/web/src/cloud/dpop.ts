...
export const readStoredBrowserDpopKey: Effect.Effect<BrowserDpopKey | null, BrowserDpopError> =
    ...
    : Effect.acquireUseRelease(
        ...
        (database) =>
          Effect.callback<BrowserDpopKey | null, BrowserDpopError>((resume) => {
            ...
            request.addEventListener("error", () =>
              resume(
                Effect.fail(dpopError("Could not read DPoP key.", request.error ?? undefined)),
              ),
            );

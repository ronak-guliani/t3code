...
function getDiffPanelHeaderRowClassName(mode: DiffPanelMode) {
  ...
  return cn(
    ...
    shouldUseDragRegion
      ? "drag-region h-(--app-title-bar-height) border-b border-border wco:h-[env(titlebar-area-height)] wco:pr-[calc(100vw-env(titlebar-area-width)-env(titlebar-area-x)+1em)]"

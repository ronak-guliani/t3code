...
): draft is ComposerThreadDraftState {
  return Boolean(
    draft &&
      ...
      return {
        ...
        clearProjectDraftThreadId: (projectRef) => {
          set((state) => {
            ...
            return matchingThreadKeys.reduce(removeDraftThreadReferences, state);
          });
        },
        ...
        addPreviewAnnotation: (threadRef, annotation) => {
          ...
          set((state) => {
            ...
            const previewAnnotations = [
              ...existing.previewAnnotations.filter((entry) => entry.id !== annotation.id),
              {
                ...annotation,
            ...
            return {
              draftsByThreadKey: {
                ...state.draftsByThreadKey,
                [threadKey]: { ...existing, previewAnnotations },
              },
            };
          });
        },

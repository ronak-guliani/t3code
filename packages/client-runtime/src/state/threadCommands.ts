...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    decouple: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:decouple",
      execute: (input: DecoupleThreadInput) => decoupleThread(input),
      scheduler,
      concurrency,
    }),

...
export const AuthBootstrapInput = AuthTokenExchangeRequest;
...
export const AuthBearerBootstrapResult = AuthAccessTokenResult;
...
export const AuthWebSocketTokenResult = AuthWebSocketTicketResult;

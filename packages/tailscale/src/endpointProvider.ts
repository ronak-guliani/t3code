...
type AdvertisedEndpoint = ReturnType<typeof createAdvertisedEndpoint>;
type AdvertisedEndpointProvider = CreateAdvertisedEndpointInput["provider"];
type AdvertisedEndpointSource = CreateAdvertisedEndpointInput["source"];
...
const resolveTailscaleIpAdvertisedEndpoints = (input: {
...
const resolveTailscaleMagicDnsAdvertisedEndpoint = Effect.fn(
  ...
  if (!input.dnsName) return Option.none();

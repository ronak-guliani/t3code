...
| [Workflow concurrency and recovery](.agents/references/scars/full.md#workflow-concurrency-and-recovery)                           | Dispatch, child visibility, cleanup jobs, prewarming, archiving, Git subprocess budgeting |
